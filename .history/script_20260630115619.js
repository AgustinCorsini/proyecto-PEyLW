...
// Arreglo donde se almacenarán los productos agregados
let carrito = [];
// Obtiene todos los botones Agregar
const botonesAgregar = document.querySelectorAll(".btn-agregar");

// Recorre todos los botones Agregar
botonesAgregar.forEach(boton=>{
    ...
    boton.addEventListener("click", ()=>{
        ...
        const producto = {
            // dataset sirve para leer los atributos data del html
            id: boton.dataset.id,
